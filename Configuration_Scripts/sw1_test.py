...
# Connection details for SW1 (Site A switch) - Assignment 22
switch = {
...
# SW1 has no management SVI/IP address configured (not required by
...
# have been learned on the correct VLAN, proving VLAN segmentation
# is working correctly at Site A.
testing_commands = [
