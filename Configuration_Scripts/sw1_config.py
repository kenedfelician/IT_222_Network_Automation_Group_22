...
# Connection details for SW1 (Site A switch) - Assignment 22: Data Processing Office
switch = {
    "device_type": "cisco_ios_telnet",
    "host": "192.168.15.128",     # GNS3 VM/server IP address
    "username": "admin22",        # Already configured on SW1 from an earlier run.
    "password": "Admin@2226",     # Leave these three BLANK only on a brand-new
...
# SW1 separates DataEntry (VLAN 38) and Systems (VLAN 48) traffic at Site A,
# carries both VLANs to R1 over an 802.1Q trunk, and connects the DataEntry
...
commands = [
    ...
    #     into sw1_verify.py, sw1_test.py, network_verify.py and
    ...
    # Configure the trunk port toward R1 (carries VLAN 38 and 48).
    ...
    # own GNS3 console banner, Gi1/0 is the link toward R1.
    ...
    # Configure the access port for DataEntry-PC1 (VLAN 38).
    "interface GigabitEthernet0/0",
    "switchport mode access",
    "switchport access vlan 38",
    "no shutdown",

    # Configure the access port for Systems-PC1 (VLAN 48).
    "interface GigabitEthernet0/1",
    "switchport mode access",
    "switchport access vlan 48",
    "no shutdown",

    # Configure the access port for DataEntry-PC5 (2nd DataEntry PC, VLAN 38).
    "interface GigabitEthernet0/2",
    "switchport mode access",
    "switchport access vlan 38",
    "no shutdown",

    # Configure the access port for Systems-PC6 (2nd Systems PC, VLAN 48).
